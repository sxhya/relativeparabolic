...
\end{align*}
The root subgroup $X_{2, 0}(R)$ (resp. $X_{-2,2}(R)$) is contained in $\E(\Delta_s, R) \subseteq N_{rs}$.
On the other hand, by the above argument we know that the subgroup $X_{1,-2}(R)$ (resp. subgroups $X_{-2,1}(R)$, $X_{2,-1}(R)$) are contained in $N_{rs}$.
Therefore $X_{1,0}(R) \subseteq N_{rs}$ (resp. $X_{1,-1}(R) \subseteq N_{rs}$).
Thus in all the cases we have $\U(\Sigma_s, R) \subseteq N_{rs}$.
...
In the case $\Phi=\rC_\ell$ from $x_{}$
$$X_{-1,1}(I) = X_{-1,1}(I^\indexbox{2}) \cdot X_{-1,1}(2I) \subseteq \cdot $$
