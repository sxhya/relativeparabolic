...
(this follows e.g. from~\cite[Lemma~2.1]{S}).
We have just shown that $X_{-\alpha_r}\subseteq N_{rs}$ whereas inclusions $X_{\alpha\ssub{k}} \subseteq N_{rs}$ for $\ 1\leq k\leq \ell$ and $X_{-\alpha\ssub{k}} \subseteq N_{rs}$ for $k\neq r,s$ are obvious.
\end{proof}

\subsection{The use of stability conditions.}
...
%and left multiplication by elements of $X_{-\alpha\ssub{r}}(I)$. To prove this, 
