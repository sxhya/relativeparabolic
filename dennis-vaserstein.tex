...
The main result of this subsection is the following theorem which is a relative version of Dennis---Vaserstein theorem (cf. \cite[Lemma~2.1]{ST76} and \cite[Theorem~2.5]{St78}).
Notice that M.~Stein uses the first of the above $4$ equivalent ways of writing down the decomposition while A.~Suslin and M.~Tulenbaev use the 4th.
...
\begin{enumerate}
 ...
 \item \textit{Case $\Phi = \rB_\ell$.} Using the argument from the previous case we get that $\U(\Sigma_s^{+>}, R) \subseteq N_{rs}$.
