...
The relative elementary subgroup $\E(\Phi, R, I)$ coincides with $A_{rs}$ under the following assumptions on $(R, I)$.
  \begin{center}
    ...
    2. & $\rB_\ell$, $\ell\geq 3$ & $(1, \ell)$ & $\sr(I) \leq \ell-2$ \\ \hline
...
We first show that under specified assumptions on $(R, I)$ one can satisfy the conditions of Lemma~\ref{lemma:Stein_reduction}.
Set $\Gamma = \{\lambda \in \varpi_s-\Sigma_s^+\cap \Delta_r \mid \lambda - \alpha_r \in \Lambda(\pi) \}$.
It is easy to see that $|\Gamma|=1$ for cases $\Phi=\rA_\ell, \rB_\ell$, $|\Gamma|=2$ for $\Phi=\rD_\ell$, $|\Gamma|=\ell$ for $\Phi=\rE_l$.
%TODO: Specify how we apply Lemma~\ref{lemma:uraction}

Notice that By virtue of Theorem~\ref{theorem:Stepanov} it suffices to show that $A_{rs}$ is invariant with respect to left multiplication by elements of the following two families:
