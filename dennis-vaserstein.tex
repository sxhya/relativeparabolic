...
hence by Lemma~\ref{lemma:abs} are interchanged under the action of $W(\Delta_s)$. % $\alpha$ and $\beta$ if their length is equal.
...
$$t_{-{\alpha^<_{\mathrm{max}}}}(s) = t_{-1,0}(s) = t_{1,-2}(s) \cdot t_{-1,-2}(-s)^{t_{-2, 0}(-1)} \cdot t_{-1, 2}(\xi),\ s\in I.$$
