...
For $\Phi=\rC_\ell$ and any ideal $I$ satisfying $\sr(I) \leq \ell-1$ one has $X_{-\alpha_s}(R) \subseteq N_{rs}$.
\end{lemma}
\begin{proof}
...
By \cref{item:asrUnipC} (applied to the subgroup $\G(\Delta_s, R, I)$) we find for every $g \in \EP_s(R, I)$ a matrix $x \in \U(\Sigma_r \cap \Delta_s, I)$ such that $xg \in C$.  
...
By the very definition of $C$, for every $g \in C$ one can choose $y \in \U(\Sigma_s \cap \Delta_r, I)$ such that $(y \cdot g)_{1,2} = 0$.
...
\begin{multline*} {A_{rs}}^{X_{-\alpha_s}(R)} = A'^{X_{2,1}(R)} \subseteq \EP_r(R, I)^{X_{2,1}(R)} \cdot \U(\Sigma_r^-, I)^{X_{2,1}(R)} \cdot \U(\Sigma_s^-, I) \cdot \EP_s(R, I) \subseteq \\
