...
We are going to show that $C$ satisfies the following properties.
 ...
 \end{enumerate}
%TODO: Write proof of these 2 facts. 
...
\end{multline*}
It is clear that $(yg)^{x_{2,1}(\xi)} \in \EP_1(R, I)$ hence
\begin{equation*} A'^{X_{2,1}(R)} \subseteq (\EP_\ell(R, I) \cdot \U(\Sigma_\ell^-, I) \cdot ?) ^ {X_{2,1}(R)} \subseteq \EP_\ell(R, I) \cdot \U(\Sigma_\ell^-, I) \cdot \EP_1(R, I) \subseteq A_{\ell,1}. \end{equation*}
\end{proof}