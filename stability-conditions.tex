...
We say that a row $a=(a_1,\ldots,a_{n+1})\in{}^{n+1}\!I$ is $\mathfrak{J}$-stable, if there exist $c_1,\ldots,c_n\in I$ such that
\[\mathfrak{J}(a_1,\ldots,a_{n+1})=\mathfrak{J}(a_1+c_1a_{n+1},\ldots,a_n+c_na_{n+1}).\]
\end{dfn}
\begin{dfn}\label{dfn:asr}
We say that a pair $(R,I)$ satisfies $\ASR_n(R,I)$ if satisfies $\SR_n(R,I)$ and, moreover, any row $a\in{}^{n+1}\!I$ is $\mathfrak{J}$-stable.
...
For a commutative ring $R$ and its ideal $I$ the following two statements are equivalent:
\begin{enumerate}
\item\label{asr-j-stable} Any row $a\in{}^{n+1}\!I$ is $\mathfrak{J}$-stable;
\item\label{asr-bak-like} For any $I$-unimodular row $(b,a_1,\ldots,a_n,d)\in\Ums(n+s,R,I)$ there exist $c_1,\ldots,c_n\in I$ such that $(b+b',a_1+c_1d,\ldots,a_n+c_nd)$ is $I$-unimodular for any $b'\in J$, where $J=\langle a_1,\ldots,a_n,d \rangle$.
\end{enumerate}
\end{lemma}
\begin{proof}
Assume first that any row $a\in{}^{n+1}\!I$ is $\mathfrak{J}$-stable. In particular for a given unimodular row $(b,a_1,\ldots,a_n,d)\in\Ums(n+s,R,I)$ there exist $c_1,\ldots,c_n$ such that
\[\mathfrak{J}(a_1,\ldots,a_{n+1})=\mathfrak{J}(a_1+c_1a_{n+1},\ldots,a_n+c_na_{n+1}).\]
...
To show the converse take arbitrary row $(a_1,\ldots,a_n,d)\in{}^{n+1}\!I$ and consider the $I$-unimodular row $(1,a_1,\ldots,a_n,d)\in\Ums(n+2,R,I).$
There exist $c_1,\ldots,c_n$ such that
\[ (1+b',a'_1,\ldots,a'_n)=(1+b',a_1+c_1d,\ldots,a_n+c_nd) \]
is unimodular for any $b'\in J$.
Suppose that there exists a maximal ideal $\mathfrak{m}\trianglelefteq R$ such that $a'_1,\ldots,a'_n\in\mathfrak{m}$ but at least one of the elements $d$, $a_i$ is not in $\mathfrak{m}$.
Clearly, $d\notin\mathfrak{m}$ (otherwise $a_i=a'_i-c_id\in\mathfrak{m}$ contrary to the assumption).
Note that $1+b'\notin\mathfrak{m}$, so the equation $1+\bar{b}'=0$ can not hold in the residue field $R/\mathfrak{m}$. But for $t\in R$ such that $\bar{t}=-1/\bar{d}$ one can take $b'=td\in J$, a contradiction to $1+\bar{b}'\neq0$. Hence no such $\mathfrak{m}$ exists and $\mathfrak{J}(a'_1,\ldots,a'_n)=\mathfrak{J}(a_1,\ldots,a_n,d)$.
\end{proof}
