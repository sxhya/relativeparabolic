...
\item Let $I^1$ denote the ring obtained by formally adjoining $1$ to $I$. Then $\sr(I^1)=\max(2,\sr(I))$.
\end{enumerate}
\end{prop}
...
\cite{MKV} gives the examples of rings of stable rank $1$ but of absolute stable rank $\geqslant2$. Theorem~1.3 therein shows that for principal ideal rings $\sr(R)=\asr(R)$.
