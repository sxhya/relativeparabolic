...
\begin{cor} \label{cor:embeddingBD}
 Denote by $i$ the standard embedding $\B_3 \hookrightarrow \rD_4$. 
 If $\asr(I)\leq 3$ then for every $I$-unimodular column $v \in \Ums(8, I)$ there exists $g \in \U(\Sigma_3, I) \leq \E(\rB_3, R, I)$ such that
 the upper half of the vector $i(g) \cdot v$ forms an $I$-unimodular column of height $4$.
\end{cor}
\begin{proof}
 The assertion follows from the fact that for every $g \in \U(\Sigma_4, I) \leq \E(\rD_4, R, I)$ one can find $g' \in \G(\Delta_4, R, I)$ such that
 $gg'$ lies in the image of $i\colon \G(\rB_3, R, I) \hookrightarrow \G(\rD_4, R, I)$.
\end{proof}
