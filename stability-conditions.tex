...
\end{itemize}
Then for any $I$-unimodular column $g\in \G(\Phi, R, I)$ there exist $x\in \U(\Phi^+, I)$, $y\in \U(\Phi^-, I)$ such that $(yxg \cdot e_1)_\lambda = 0$ for $\lambda\in \Gamma$.
\end{lemma}
\begin{proof}
...
$g'=h_2 \cdot z_{-\alpha\ssub{2}}(-v'_2, 1) \cdot h_1 \cdot g$ fix $e_1$. Using Levi decomposition we can rewrite $g'=h \cdot y \cdot x \cdot g$ for some $y\in\U(\Sigma^-_\ell, I)$, $x \in \U(\Sigma^+_\ell, I)$, $h\in\E(\Delta_\ell, R, I)$.
Now, it is clear that $x$, $y$ are the desired elements.
\end{proof}