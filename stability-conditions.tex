...
By definition, the {\it stable rank} of $I$ (denoted $\sr(I)$) is the smallest natural number $n$ such that $\SR_n(I)$ holds (we set $\sr(I)=\infty$ if no such $n$ exists).
...
\end{itemize}
%The last estimate further improves to $\sr(F[x_1, \ldots, x_n])\leqslant n$ for $F$ algebraic over a finite field (see~\cite[Corollary~17.4]{VS76}).
