...
\begin{cor} \label{cor:embeddingBD}
 ...
 If $\asr(I) \leqslant \ell-1$ then for every $I$-unimodular column $v \in \Ums(8, I)$ there exists $g \in \U(\Sigma_3, I) \leq \E(\rB_3, R, I)$ such that
 the upper half of the vector $i(g) \cdot v$ forms an $I$-unimodular column of height $4$.
\end{cor}
\begin{proof}
 The assertion follows from the fact that for every $u \in \U(\Sigma_\ell, I) \leq \E(\rD_\ell, R, I)$ one can find $u' \in \G(\Delta_\ell, R, I)$ such that
 $uu'$ lies in the image of $i$. Namely, denote by $\sigma$ the symmetry of the Dynkin diagram of $\rD_\ell$,
 and decompose $u$ into the product $u_1 \cdot u_2$, $u_1 \in \U(\Sigma_\ell\cap\Delta_{\ell-1}, I)$, $u_2 \in \Sigma(\Sigma_\ell \cap \Sigma_{\ell-1}, I)$.
