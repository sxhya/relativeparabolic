...
Assume $\sr(R)\leqslant2$ in case $\Phi=\rA_\ell,\rC_\ell$ and $\asr(R)\leqslant2$ in case $\Phi=\rB_\ell,\rD_\ell$. Then every element of $\G(\Phi,R,I)$ is a product of an element of $\G(\langle\pm\alpha_\ell\rangle,R,I)$, at most $\ell$ elements of the form $z_{-\alpha}(*,*)$, $\alpha$ the maximal root of a terminal subsystem containing $\alpha_\ell$, and at most $N$ elementary root unipotents $x_\alpha(s)$, $s\in I$, where $N$ is $3\left|\Phi^+\right|+\ell$ in case $\Phi=\rA_\ell,\rC_\ell$ and $N=4\left|\Phi^+\right|-\ell$ in case $\Phi=\rB_\ell,\rD_\ell$.
\end{cor}
\begin{proof}
The improved estimate for $\Phi=\rA_\ell,\rC_\ell$ is obtained by using the fact that it suffices to make only two additions to make the shorter column unimodular in the first step of the Bass---Kolster decomposition.
\end{proof}
\[
