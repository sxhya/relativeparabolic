...
Denote $v=(1+r_1,r_2,\ldots,r_\ell,r_{-\ell},\ldots,r_{-1})^t\in\Ums(2\ell,R,I)$.
Find $c_1,\ldots,c_{-2}\in I$ such that $(1+r_1+c_1r_{-1},\ldots,r_{-2}+c_{-2}r_{-1})=(1+r_1',\ldots,r_{-2}')\in\Ums(2\ell-1,R,I)$.
First add $c_{-i}r_{-1}$ to $r_{-i}$ for $-i=-\ell,\ldots,-2$, so that
\[ \begin{pmatrix}
1+r_1 \\ r_i \\ r_{-i} \\ r_{-1}
\end{pmatrix}
\longmapsto
...
\xmapsto{x_{-\gamma}(1)}
\begin{pmatrix}1 \\ \vdots \\ 0\end{pmatrix}. \]
Now apply $2\ell-2$ lower transformation to obtain zeroes on positions $i=2,\ldots,-2$, that will also add $\sum_{i=2}^\ell (r_i+r_{-i})$ to $r_{-1}$,
...
one has $\bar{v'}^+=(\bar{v'_1},\ldots, \bar{v'_\ell}) \in \Ums(\ell, R/J, I/J)$ and, therefore, $(v'^+, v'^-) \in \Ums(2\ell, R, I)$ and one can repeat the argument for the case $\Phi=\rD_l$.
(clearly, the maximal root of $\rD_\ell$ maps to the maximal root of $\rB_\ell$ with respect natural embedding $\rD_\ell\subseteq\rB_\ell$). \end{proof}