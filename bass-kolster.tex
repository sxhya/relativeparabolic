...
Applying condition $\sr(I)\leq 2\ell-1$ wes find $c_1, c_2, \ldots, c_{-2} \in I \cdot v_{-1}$ such that upper $2\ell -1$ components of $v'=(v_1 + c_1 v_{-1}, \ldots, v_{-2} + c_{-2}v_{-1}, v_{-1})^t$ form an $I$-unimodular column.
...
Set $\xi = v''_1-v''_{-1}-1 \in I$, $h_2 = t_{-1,1}(\xi f_1 \pm \sum_{i=2}^\ell v_1' \xi^2 f_i f_{-i}) \cdot \prod_{i=2}^{-2} t_{-1,i}(\xi f_i) \in \U(\Sigma_\ell, I)$.
...
Set $\xi = v''_1-v''_{-2}-1 \in I$, $h_3 = t_{1,-2}(\xi f_1) \cdot \prod_{i=3}^\ell t_{i,-2}(\xi f_i)$, $v'''=h_3 \cdot v''$.
