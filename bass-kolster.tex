...
By relative Chevalley---Matsumoto lemma it suffices to show that the set $\Z \cdot \U(\Phi^-, I) \cdot \U(\Phi^+, I) \cdot g$ contains an element $h$ such that $\mu_1(h\cdot v^+)=1$, $\mu_{\varpi\ssub{1} - \alpha\ssub{max}}(h \cdot v^+)=0$.
