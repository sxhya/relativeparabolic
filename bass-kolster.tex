...
Under the assumptions on $\Phi$, $I$ and $N'$ stated below every element of $\G(\Phi,R,I)$ can be factored into a product of 
one element of $\G(\langle\pm\alpha_\ell\rangle,R,I)\cong\SL(2,R,I)$ and at most $N'$ elements of $\mathcal{Z}(\Sigma_\ell)$:
