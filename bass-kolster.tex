...
Assume $\sr(I)\leqslant2$ in case $\Phi=\rA_\ell$, $\sr(I)\leqslant3$ in case $\rC_\ell$ and $\asr(I)\leqslant2$ in case $\Phi=\rB_\ell,\rD_\ell$. Then every element of $\G(\Phi,R,I)$ is a product of an element of $\G(\langle\pm\alpha_\ell\rangle,R,I)$, at most $\ell-1$ elements of the form $z_{-\alpha}(*,*)$, $\alpha$ the maximal root of some terminal subsystem containing $\alpha_\ell$, and at most $N$ elementary root unipotents $x_\alpha(s)$, $s\in I$, where $N$ is $3\left|\Phi^+\right|+\ell$ in case $\Phi=\rA_\ell$, $N=3\left|\Phi^+\right|+2\ell$ in case $\Phi=\rC_\ell$ and $N=4\left|\Phi^+\right|-\ell$ in case $\Phi=\rB_\ell,\rD_\ell$.
\end{cor}
\begin{proof}
