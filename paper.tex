...
\end{thmlist}
\end{thm}
Here $W(G, X)$ denotes \emph{the width of $G$ with respect to a generating set $X$}, i.\,e. the smallest natural number $N$ such that every element of $G$ is a product of at most $N$ elements of $X$.
