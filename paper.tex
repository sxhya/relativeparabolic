...
As a further application of parabolic factorizations, we obtain in~\cref{thm:width} estimates of the width $\E(\Phi, R, I)$  
 with respect to this generating set for some special rings $R$.
...
Recall that the \emph{relative elementary Chevalley subgroup} $\E(\Phi, R, I) \leqslant \G(\Phi, R, I)$ is defined as the normal closure in $\E(\Phi, R)$ of the subgroup $\E(\Phi, I)$ generated by the set $\mathcal{X} = \{x_\alpha(\xi) \mid \alpha\in \Phi, \ \xi \in I \}$.
...
The following result describes generating sets of $\E(\Phi, R, I)$.
...
Denote by $I^{\indexbox{2}}$ the ideal of $R$ generated by all squares $a^2$, where $a\in I$.
