...
\usepackage[hyperref=true, backend=biber, citestyle=numeric-comp, sortlocale=en_US, url=false, doi=false, eprint=true, maxbibnames=4]{biblatex}            
...
\newlist{thmlist}{enumerate}{1} \setlist[thmlist]{label={\rm(\arabic{thmlisti})}, ref=\thethm.(\arabic{thmlisti}),noitemsep} \Crefname{thmlisti}{Theorem}{Theorems}
